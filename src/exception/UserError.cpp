...
UnknownCommand::UnknownCommand(const TokenStream& ts) : UserError(std::format("unknown command {}", ts.toString())) {}

AlreadyExists::AlreadyExists(std::string_view what) : UserError(std::format("already exists: {}", what)) {}

DoesNotExist::DoesNotExist(std::string_view what) : UserError(std::format("does not exist: {}", what)) {}

MissingInput::MissingInput(std::string_view what) : UserError(std::format("missing input: {}", what)) {}
